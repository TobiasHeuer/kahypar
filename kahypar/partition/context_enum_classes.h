...
inline std::ostream& operator<< (std::ostream& os, const EvoReplaceStrategy& replace) {
  switch (replace) {
...
inline std::ostream& operator<< (std::ostream& os, const EvoCombineStrategy& combine) {
  switch (combine) {
...
inline std::ostream& operator<< (std::ostream& os, const EvoMutateStrategy& mutation) {
  switch (mutation) {
...
inline std::ostream& operator<< (std::ostream& os, const EvoDecision& decision) {
  switch (decision) {
...
inline std::ostream& operator<< (std::ostream& os, const RatingPartitionPolicy& policy) {
  switch (policy) {
...
inline std::ostream& operator<< (std::ostream& os, const ContextType& type) {
...
inline std::ostream& operator<< (std::ostream& os, const CommunityPolicy& comm_policy) {
  switch (comm_policy) {
...
inline std::ostream& operator<< (std::ostream& os, const FixVertexContractionAcceptancePolicy& acceptance_policy) {
  switch (acceptance_policy) {
...
inline std::ostream& operator<< (std::ostream& os, const Objective& objective) {
  switch (objective) {
...
inline std::ostream& operator<< (std::ostream& os, const InitialPartitioningTechnique& technique) {
  switch (technique) {
...
inline std::ostream& operator<< (std::ostream& os, const RefinementAlgorithm& algo) {
  switch (algo) {
...
inline std::ostream& operator<< (std::ostream& os, const InitialPartitionerAlgorithm& algo) {
  switch (algo) {
...
inline std::ostream& operator<< (std::ostream& os, const LouvainEdgeWeight& weight) {
  switch (weight) {
...
inline std::ostream& operator<< (std::ostream& os, const RefinementStoppingRule& rule) {
  switch (rule) {
...
inline std::ostream& operator<< (std::ostream& os, const FlowAlgorithm& algo) {
  switch (algo) {
...
inline std::ostream& operator<< (std::ostream& os, const FlowNetworkType& type) {
  switch (type) {
...
inline std::ostream& operator<< (std::ostream& os, const FlowExecutionMode& mode) {
  switch (mode) {
